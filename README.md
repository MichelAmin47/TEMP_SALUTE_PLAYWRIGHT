...
![Test](https://github.com/ValoriSolutions/SALUTE_Typescript_Playwright/workflows/Test/badge.svg)
...
- `npm run test features/Smoke.feature` - run a specific feature file
- `npm run debug-only` - run a specific scenario with tag @only in debug mode
